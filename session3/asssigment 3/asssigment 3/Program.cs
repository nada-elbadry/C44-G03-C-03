...
namespace Session03
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            string input = Console.ReadLine()??"Error Number";
            Console.WriteLine($"You entered: {input}");
            */
            #endregion

            #region 2. Convert Non-Numeric String to Integer
            // Converts a string with non-numeric characters to an integer
            /*
            string str = "123_nada";
            try
            {
            ...
            */
            ...
            double rate = Convert.ToDouble(Console.ReadLine()?? "Error Rate");
